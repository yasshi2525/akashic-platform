...
function toMessage(message?: string | null): {
    ...
    switch (message) {
        ...
        case messages.content.editSuccessful:
            return { severity: "success", message: "ゲームが更新されました" };
        case messages.content.deleteSuccessful:
            return { severity: "success", message: "ゲームが削除されました" };
